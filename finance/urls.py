...
urlpatterns = [
    ...
    path("ahorros/metas/", views.SavingGoalListView.as_view(), name="saving_goal_list"),
    path("ahorros/metas/crear/", views.SavingGoalCreateView.as_view(), name="saving_goal_create"),
    path("ahorros/metas/<int:pk>/editar/", views.SavingGoalUpdateView.as_view(), name="saving_goal_update"),
    path("ahorros/metas/<int:pk>/eliminar/", views.SavingGoalDeleteView.as_view(), name="saving_goal_delete"),
    path("savings/goals/", views.SavingGoalListView.as_view()),
    path("savings/goals/create/", views.SavingGoalCreateView.as_view()),
    path("savings/goals/<int:pk>/edit/", views.SavingGoalUpdateView.as_view()),
    path("savings/goals/<int:pk>/delete/", views.SavingGoalDeleteView.as_view()),
